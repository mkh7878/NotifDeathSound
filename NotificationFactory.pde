class NotificationFactory {
  ...
  Notification createNotification(PImage image, SoundFile soundEffect) {     // Function of return type Notification, no arguments
    ...
    Notification notification = new Notification(xpos, ypos, wid, len, image, soundEffect);
